...
```{r}
  ...
  eossa_old <- eossa(s, nested.groups = list(1:7), k = 2)
  res_old <- reconstruct(eossa_old, groups = eossa_old$iossa.groups)
```
...
```{r}
  ...
  eoss <- eossa(s, nested.groups = list(1:6), k = 3)
...
```{r}
  ...
  eoss <- eossa(s, nested.groups = list(1:14), k = 5)
  res_old = reconstruct(eoss, groups = eoss$iossa.groups)
...
```{r}
  ...
  eoss <- eossa(s, nested.groups = list(1:16), k = 5)
  res_old = reconstruct(eoss, groups = eoss$iossa.groups)
