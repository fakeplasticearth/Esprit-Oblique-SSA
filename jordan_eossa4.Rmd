...
Не только. Если посмотреть на матрицу левых сингулярных векторов, то можно увидеть, что она сильно отличается при большом шуме (начиная с $\sigma = 5$). Не срабатывает даже правило группировки: факторные вектора не похожи на медленно меняющиеся компоненты.
